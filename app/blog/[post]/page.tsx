...
const fallbackImage: string =
  "https://res.cloudinary.com/roshankharel/image/upload/v1692636087/roshankharel/blog.png";
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: `${post.title}`,
    metadataBase: new URL(`https://roshankharel.com/blog/${post.slug}`),
    description: post.description,
    publisher: post.author.name,
    keywords: post.tags,
    alternates: {
      canonical:
        post.canonicalLink || `https://roshankharel.com/blog/${post.slug}`,
    },
    openGraph: {
      images:
