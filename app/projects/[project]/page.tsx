...
const fallbackImage: string =
  "https://res.cloudinary.com/roshankharel/image/upload/v1692636087/roshankharel/projects.png";
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    metadataBase: new URL(`https://geekyroshan.com/projects/${project.slug}`),
    description: project.tagline,
    openGraph: {
      images: project.coverImage
        ? urlFor(project.coverImage.image).width(1200).height(630).url()
        : fallbackImage,
      url: `https://geekyroshan.com/projects/${project.slug}`,
      title: project.name,
      description: project.tagline,
    },
  };
